        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <?php if ($complaint): ?>
                    <!-- Complaint Details -->
                    <div class="mb-4">
                        <h5><i class="bi bi-info-circle-fill me-2"></i><?php echo __('complaint_details'); ?></h5>
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="mb-4">
                        <h5><i class="bi bi-chat-left-text-fill me-2"></i><?php echo __('subject'); ?></h5>
                        <p><?php echo $complaint['subject']; ?></p>
                    </div>

                    <div class="mb-4">
                        <h5><i class="bi bi-file-text-fill me-2"></i><?php echo __('description'); ?></h5>
                        <p><?php echo nl2br($complaint['description']); ?></p>
                    </div>

                    <div class="mb-4">
                        <h5><i class="bi bi-geo-alt-fill me-2"></i><?php echo __('location'); ?></h5>
                        <p><?php echo $complaint['location']; ?></p>
                    </div>

                    <?php if (!empty($complaint['attachment'])): ?>
                        <div class="mb-4">
                            <h5><i class="bi bi-paperclip me-2"></i><?php echo __('attachment'); ?></h5>
                            <p>
                    ...
                    <?php if (!empty($complaint['admin_response'])): ?>
                        <div class="mb-4">
                            <h5><i class="bi bi-reply-fill me-2"></i><?php echo __('admin_response'); ?></h5>
                            <div class="card">
                                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                ...
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-primary"><i class="bi bi-search me-2"></i><?php echo __('track'); ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
